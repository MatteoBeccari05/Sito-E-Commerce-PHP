...
<div class="container" id="cart-container" style="margin-top: 100px;">
    ...
    <?php else: ?>
        ...
        <?php endforeach; ?>
        <h4 class="text-center"><strong>Totale Carrello: €<?= number_format($total, 2); ?></strong></h4>
        <br>
        <div class="text-center">

            <?php if (isset($_SESSION['username'])): ?>
                <button type="button" class="add-to-cart-btn" onclick=window.location.href="pagamento.php">Procedi al pagamento</button>
            <?php else: ?>
                <p class="esaurito">Devi essere loggato per procedere con il pagamento.</p>
            <?php endif; ?>
        </div>
